...
namespace LoLTournament.Authentication
{
    public class MongoRoleProvider : RoleProvider
    {
        ...
        public override string[] GetRolesForUser(string username)
        {
            ...
            var roles =
                Mongo.Users.Find(Query<User>.Where(x => x.UserName == username)).
                    Select(x => x.Roles).Single().ToArray();
        ...
        public override void AddUsersToRoles(string[] usernames, string[] roleNames)
        {
            ...
            {
                var user = Mongo.Users.Find(Query<User>.Where(x => x.UserName == u)).
                    SingleOrDefault();
        ...
        {
            var users = Mongo.Users.Find(Query<User>.Where(x => x.Roles.Contains(roleName))).Select(x => x.UserName).ToArray();
